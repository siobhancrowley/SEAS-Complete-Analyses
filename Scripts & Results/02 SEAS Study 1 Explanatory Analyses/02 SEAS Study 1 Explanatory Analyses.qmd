...
The number of explanations that reference the game with specific details given by participants does significantly differ by age, t = `r round(summary(seas_SG_count_age)$coefficients[2,3], 2)`, p = `r signif(summary(seas_SG_count_age)$coefficients[2,4], 2)`.
